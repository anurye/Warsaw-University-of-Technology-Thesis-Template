...
onlysources.tex		?= wut_thesis.tex
#onlysources.lhs	?=
#onlysources.tex.sh	?=
#onlysources.tex.pl	?=
#onlysources.tex.py	?=
...
# This *always* deletes pstex files, even if they were not generated by
...
# Remove all compiled pdf files.
.PHONY: realclean
realclean:
	rm -f externalize-tikz/thesis-*
	rm -f thesis-*pdf
